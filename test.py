...
def __lldb_init_module(debugger, internal_dict):
    debugger.HandleCommand('command script add -f test.handle_command test -h "Short documentation here"')
...
def handle_command(debugger, command, exe_ctx, result, internal_dict):
    ...
    result.AppendMessage('Hello! the test command is working!')


def generate_option_parser():
    usage = "usage: %prog [options] TODO Description Here :]"
    parser = optparse.OptionParser(usage=usage, prog="test")
